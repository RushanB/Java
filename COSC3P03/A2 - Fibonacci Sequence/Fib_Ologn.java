...
public final class Fib_Ologn {
    ...
    //multiplies matrix MxN and returns result
    ...
    public static void main(String[] args) {
        for (int i = 0; i <= 10; i++) {  //fibonacci value
          System.out.println("Fibonacci " + i + " " + getNthfibo(i));
        }
    }
}